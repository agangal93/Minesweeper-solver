...
class BoardDesign:
    ...
    def BoardDesign_CreateBoard(self):
        ...
        self.cell_array[11].Cell_SetMine()
        self.cell_array[15].Cell_SetMine()
        self.cell_array[23].Cell_SetMine()
        self.cell_array[45].Cell_SetMine()
        self.cell_array[49].Cell_SetMine()
        self.cell_array[58].Cell_SetMine()
        self.cell_array[65].Cell_SetMine()
        self.cell_array[66].Cell_SetMine()
        self.cell_array[72].Cell_SetMine()
        self.cell_array[74].Cell_SetMine()
        self.cell_array[78].Cell_SetMine()
        self.cell_array[88].Cell_SetMine()
        self.cell_array[94].Cell_SetMine()
        self.cell_array[98].Cell_SetMine()
        self.cell_array[99].Cell_SetMine()
        self.cell_array[100].Cell_SetMine()
        self.cell_array[102].Cell_SetMine()
        self.cell_array[103].Cell_SetMine()
        self.cell_array[124].Cell_SetMine()
        self.cell_array[128].Cell_SetMine()
        self.cell_array[135].Cell_SetMine()
        self.cell_array[137].Cell_SetMine()
        self.cell_array[153].Cell_SetMine()
        self.cell_array[170].Cell_SetMine()
        self.cell_array[171].Cell_SetMine()
        self.cell_array[172].Cell_SetMine()
        self.cell_array[173].Cell_SetMine()
        self.cell_array[175].Cell_SetMine()
        self.cell_array[186].Cell_SetMine()
        self.cell_array[188].Cell_SetMine()
        self.cell_array[193].Cell_SetMine()
        self.cell_array[194].Cell_SetMine()
        self.cell_array[204].Cell_SetMine()
        self.cell_array[208].Cell_SetMine()
        self.cell_array[209].Cell_SetMine()
        self.cell_array[211].Cell_SetMine()
        self.cell_array[216].Cell_SetMine()
        self.cell_array[241].Cell_SetMine()
        self.cell_array[245].Cell_SetMine()
        self.cell_array[247].Cell_SetMine()
    ...
    def StartExploration(self,start,master,w):
        ...
        node = start
        # Start exploration
        # Continue exploration until all cells on the board are explored or flagged as mine
        while (len(explored_cells) + len(KB.mine_cells) != ((self.dim_x*self.dim_y))) and not hit_mine:
            n = 0
            edge_cells = []
            ...
            if explored_cells:
                master.after(100,self.color_cell(explored_cells,w,'red'))
            if KB.mine_cells:
                master.after(100,self.color_cell(KB.mine_cells,w,'yellow'))

            # Explored count exceeded number of cells
            assert(len(explored_cells) + len(KB.mine_cells) <= ((self.dim_x*self.dim_y)))
...
#print("Score - %f"%(mines_hit/num_mines))
